...
export const metadata: Metadata = {
  title: "Sell your iPhone — Best Price & Instant Cash | Mobronix",
  description: "Get the maximum value for your used iPhone. Instant price quote, free doorstep pickup, and immediate UPI payout in Mumbai, Navi Mumbai, Thane & Sangli.",
};

export default async function IPhoneCatalogPage() {
    ...
    <div className="space-y-6 pt-4 sm:pt-8">
      ...
      <div className="px-4 sm:px-0">
        ...
        <p className="mt-1.5 text-body-sm text-text-secondary">
          Select your iPhone model below to get an instant, honest condition-based valuation.
        </p>
      </div>
